...
- Replace the staged browser cart with direct Medusa Store API cart creation/completion once payment, tax, and final shipping/pickup settings are approved.
